...
<body>
	...
	<div class="col-xs-12">
		<center><h3>Anáise Diaria 19/05</h3></center>
		<div class="col-md-8 col-md-offset-2">
			<div class="row">
				...
				<?php
					...
					$caminhoDB = "C:\RCK\BANCOS\Green_Produtos_Naturais\Conferencia_500\DB_5_20_.RCK";
					$conn = conectaBanco($caminhoDB);
					
					$db_nome = "DB_5_20_.RCK";

					$data_busca = "5/19/2017";
					$data_exibe = "19/5/2017";

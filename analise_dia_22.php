...
<body>
	...
	<div class="col-xs-12">
		<center><h3>Anáise Diaria 22/05</h3></center>
		<div class="col-md-8 col-md-offset-2">
			<div class="row">
				<?php
					...
					$caminhoDB = "C:\RCK\BANCOS\Green_Produtos_Naturais\Conferencia_500\DB_5_23_.RCK";
					$conn = conectaBanco($caminhoDB);

					$db_nome = "DB_5_22_.RCK";

					$data_busca = "5/22/2017";
					$data_exibe = "22/5/2017";
